...
function connect_database() {
    $bdd =  mysqli_connect('localhost', 'remi', 'remi123', 'remi-garguilo_blog');
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($email && $newemail && $repeatnewemail) {
                if (!filter_var($newemail, FILTER_VALIDATE_EMAIL)) {
                    ...
                    $Bdd = mysqli_connect('localhost', 'remi', 'remi123', 'remi-garguilo_blog') or die('Erreur');
