...
function connect_database() {
    $bdd =  mysqli_connect('localhost', 'hugo-chabert', 'chabertBLOG', 'hugo-chabert_blog');
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($email && $newemail && $repeatnewemail) {
                if (!filter_var($newemail, FILTER_VALIDATE_EMAIL)) {
                    ...
                    $Bdd = mysqli_connect('localhost', 'hugo-chabert', 'chabertBLOG', 'hugo-chabert_blog') or die('Erreur');
